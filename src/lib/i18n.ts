...
const dict = {
	id: {
		...
		schedulePlatformLabel: 'Platform jadwal ini',
		schedulePlatformInherit: 'Sama seperti platform utama',
		channelSlot: (n: number) => `Channel tambahan ${n}`,
		channelAdd: 'Tambah platform lain',
		channelHint: 'Kosongkan username kalau channel ini mau dihapus.',
		channelReview:
			'Perubahan channel selalu diperiksa manual dulu, walaupun kunci edit kamu benar.',
	...
	en: {
		...
		schedulePlatformLabel: 'Platform for this schedule',
		schedulePlatformInherit: 'Same as main platform',
		channelSlot: (n: number) => `Extra channel ${n}`,
		channelAdd: 'Add another platform',
		channelHint: 'Clear the username to drop this channel.',
		channelReview:
			'Channel changes are always checked by hand first, even with the right edit key.',
